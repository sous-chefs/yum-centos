...
default['yum']['centos-nfs-ganesha']['mirrorlist'] =
  "http://mirrorlist.centos.org/?release=#{release_var}&arch=$basearch&repo=storage-nfsganesha-#{ver}"
...
default['yum']['centos-nfs-ganesha-testing']['baseurl'] =
  "https://buildlogs.centos.org/centos/#{release_var}/storage/$basearch/nfsganesha-#{ver}/"
