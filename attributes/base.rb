...
default['yum']['base']['description'] = "#{centos_description} - Base"
default['yum']['base']['enabled'] = true
default['yum']['base']['make_cache'] = true
default['yum']['base']['managed'] = true
if node['platform_version'].to_i >= 8
  default['yum']['base']['mirrorlist'] =
    "http://mirrorlist.centos.org/?release=#{release_var}&arch=$basearch&repo=BaseOS"
